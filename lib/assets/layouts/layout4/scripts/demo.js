...
var Demo = function () {
    ...
    var submenuActiveFun=function(){
        $('.page-sidebar').on('click', 'li > a', function(e) {
            var $this=$(this);
             var liDom=$(".page-sidebar").find("li");
          liDom.removeClass("open").removeClass("active");
            $this.parent().addClass("active");
            $this.closest("ul").parent().addClass("open").addClass("active");
